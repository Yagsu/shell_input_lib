...
/*   Updated: 2020/07/09 00:44:28 by jesse            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_info	*initstruct_sn(t_snbuffer *buffer)
{
	t_info *new_info;
...
t_info	*getstruct_sn(const char **format_position, t_snbuffer *buffer, \
		va_list arglist)
{
	t_info *info;
